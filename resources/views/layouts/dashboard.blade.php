    ...
    >
      <div class="text-gray-100 text-xl">
        <div class="p-2.5 mt-1 flex items-center">
          <i class="bi bi-app-indicator px-2 py-1 rounded-md bg-red-600"></i>
      ...
      >
        ...
        <span class="text-[15px] ml-4 text-gray-200 font-bold">Your Post</span>
      </div></a>
      <a href="/createpost"><div
        class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-red-600 text-white"
      >
        <i class="bi bi-bookmark-fill"></i>
        <span class="text-[15px] ml-4 text-gray-200 font-bold">Create New Post</span>
      </div></a>
      ...
      {{-- <div
        ...
        id="submenu"
      >
        <h1 class="cursor-pointer p-2 hover:bg-red-600 rounded-md mt-1">
          Social
        </h1>
        <h1 class="cursor-pointer p-2 hover:bg-red-600 rounded-md mt-1">
          Personal
